...
export default function InputBox(props) {
  const { date, semester, weeks, handlers } = props
  return (
    <form onSubmit={handlers.submitHandler}>
      <div className='max-w-md mx-auto my-8 bg-white p-6 rounded-md shadow-md'>
        ...
        <label htmlFor='week' className='block text-gray-700 font-bold my-2'>
          Number of weeks:
        </label>
        <input
          type='number'
          ...
          className='border border-gray-400 p-2 rounded-md w-full'
        />
        <label htmlFor='date' className='block text-gray-700 font-bold my-2'>
          Starting date:
        </label>
        <input
          type='date'
